...
{
    int table1_len, table2_len, j;
    int table1_idx = 0, table2_idx = 0;
    page * table1_page, * table2_page;
    off_t table1_leaf_offset, table2_leaf_offset;
    ...
    while (table1_len > 0 && table2_len > 0) {
        ...
        if (table1_records[table1_idx].key == table2_records[table2_idx].key) {
            printf("%ld,%s,%s\n", table1_records[table1_idx].key, table1_records[table1_idx].value, table2_records[table2_idx].value);
            table1_idx++;
            table2_idx++;
        }
